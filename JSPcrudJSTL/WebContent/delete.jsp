...
<body>
	...
	<sql:update dataSource="${mysqlds}" var="status">delete from dept where dept_id='${param.dept_id}'</sql:update> 
	<core:if test="(${status}==0)">
	<core:out value="Error while deleting !!! pls check"></core:out>
	</core:if>
